...
function addCart(id){
	...
	location.href="CartServlet?buyNum="+num+"&pid="+id;
	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="PageServlet">首页&nbsp;&nbsp;&gt;</a> <a href="">课程&nbsp;&nbsp;&gt;</a>
				<a>x课程</a>
			</div>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						优惠价: <strong style="color: #ef0101;">￥元</strong> 参 考 价：
						<del>￥元</del>
					</div>
					...
					<div
						style="padding: 10px; border: 1px solid #e7dbb1; width: 330px; margin: 15px 0 10px 0;; background-color:#ffcccc;">
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<a href="javascript:viod(0)"> <input
