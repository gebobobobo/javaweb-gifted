			...
			<form class="layui-form">
				<div class="layui-form-item">
					<label for="phone" class="layui-form-label"> <span
						class="x-red">*</span>主题图片
					</label>
					<div class="layui-input-inline">
						<input type="file" id="phone" name="phone" class="layui-input"
				...
				<div class="layui-form-item">
					<label for="username" class="layui-form-label"> <span
						class="x-red">*</span>主题类型
					</label>
					<div class="layui-input-inline">
						<select id="shipping" name="shipping" class="valid">
							<option value="shentong">请选择</option>
							<option value="shentong">新闻</option>
							<option value="shunfeng">资讯</option>
						</select>
					</div>
				</div>
		</div>
		<div class="layui-form-item layui-form-text">
			<label for="desc" class="layui-form-label">主题内容</label>
