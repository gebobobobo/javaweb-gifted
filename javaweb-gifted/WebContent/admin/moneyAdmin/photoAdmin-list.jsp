...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a href="">首页</a> <a href="">图片管理</a>
			<a> <cite>图片管理</cite></a>
				...
				<div class="layui-card">
					...
					<div class="layui-card-header">
						...
						<button class="layui-btn"
							onclick="xadmin.open('添加订单','./photoAdmin-add.jsp',800,600)">
							...
							<tbody>
								<tr>
									...
									<td class="td-manage"><a title="编辑" href="javascript:;"
										onclick="xadmin.open('编辑','./photoAdmin-add.jsp','800','510','1')"
