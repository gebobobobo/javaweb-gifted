...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a href="">首页</a> <a href="">员工资源管理</a>
			<a> <cite>员工信息</cite></a>
				...
				<div class="layui-card">
					<div class="layui-card-body ">
						<form class="layui-form layui-col-space5">
							...
							<div class="layui-inline layui-show-xs-block">
								<input class="layui-input" autocomplete="off" placeholder="授课老师"
									name="end">
							</div>
					...
					<div class="layui-card-header">
						...
						<button class="layui-btn"
							onclick="xadmin.open('添加','./employeeInfo-add.jsp',800,600)">
							...
							<tbody>
								<tr>
									...
									<td class="td-manage"><a title="查看"
										onclick="xadmin.open('编辑','employeeInfo-edit.jsp')"
								...
								<tr>
									...
									<td>讲课详细，经验丰富</td>
									<td class="td-manage"><a title="查看"
										onclick="xadmin.open('编辑','teacherInfo-edit.jsp')"
										href="javascript:;"> <i class="layui-icon">&#xe63c;</i></a> <a
										title="删除" onclick="member_del(this,'要删除的id')"
										href="javascript:;"> <i class="layui-icon">&#xe640;</i></a></td>
								</tr>
