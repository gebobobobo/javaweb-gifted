				...
				<div class="layui-card">
					...
					<div class="layui-card-header">
						...
						<button class="layui-btn"
							onclick="xadmin.open('添加用户','studentOut-add.jsp',800,600)">
					...
					<div class="layui-card-body ">
						<table class="layui-table layui-form">
							<thead>
								<tr>
									<th class="thOne"><input type="checkbox" name=""
										lay-skin="primary"></th>
									<th>学员编号</th>
									<th>学员靓照</th>
									<th>学员姓名</th>
							...
							<tbody>
								<tr>
					                ...
					                <td><img src="ueditor/themes/default/images/videologo.gif" name="studentphoto"></td>
									<td>王涵</td>
									<td>一年级</td>
									<td>语文</td>
									<td>12345678906</td>
									...
									<td class="td-manage"><a title="编辑"
										onclick="xadmin.open('编辑','studentPerpare-edit.html')"
