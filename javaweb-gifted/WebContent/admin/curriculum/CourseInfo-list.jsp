				...
				<div class="layui-card">
					<div class="layui-card-body ">
						...
						<form class="layui-form layui-col-space5">
							<div class="layui-inline layui-show-xs-block">
								<input class="layui-input" autocomplete="off" placeholder="选择课程"
									name="start">
							</div>
							<div class="layui-inline layui-show-xs-block">
								<input class="layui-input" autocomplete="off" placeholder="代课老师"
									name="end">
							</div>
							<div class="layui-inline layui-show-xs-block">
					...
					<div class="layui-card-header">
						...
						<button class="layui-btn"
							onclick="xadmin.open('添加课程信息','${pageContext.request.contextPath}/admin/curriculum/Courseinfo-add.jsp')">
							...
							<tbody>
								<tr>
									<td><input type="checkbox" name="id" value="1"
										lay-skin="primary"></td>
									<td>1</td>
									<td><img src="${pageContext.request.contextPath}/img/banner_04.jpg"></td>
									<td>语文</td>
									<td>一年级</td>
									<td>王老师</td>
									<td>2018-01-01 11:11:42</td>
									<td class="td-status">aaa</td>
									<td class="td-status">￥20.0</td>
									<td class="td-status">小学课程</td>
									<td class="td-manage"><a title="编辑" href="javascript:;"
										onclick="xadmin.open('编辑','Courseinfo-edit.jsp')"
								...
								<tr>
									...
									<td class="td-status">小学课程</td>
									<td class="td-manage"><a title="编辑" href="javascript:;"
										onclick="xadmin.open('编辑','Courseinfo-edit.html')"
										class="ml-5" style="text-decoration: none"> <i
											class="layui-icon">&#xe642;</i>
									</a> <a title="删除" href="javascript:;"
										onclick="member_del(this,'1')" style="text-decoration: none">
