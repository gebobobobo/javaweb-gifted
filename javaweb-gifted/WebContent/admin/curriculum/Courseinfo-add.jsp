				...
				<div class="layui-tab-content">
					<div class="layui-tab-item layui-show">
						...
						<div class="layui-form-item">
							<label class="layui-form-label"> <span class='x-red'>*</span>课程图片
							</label>
							<div class="layui-input-block">
								<input type="file" name="title" autocomplete="off" value=""
									placeholder="请输入选中的视频" class="layui-input" id="classMode">
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label"> <span class='x-red'>*</span>课程名
							</label>
							<div class="layui-input-block">
								<input type="text" name="title" autocomplete="off" value=""
									placeholder="空制在80个汉字，160个字符以内" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label"> <span class='x-red'>*</span>所属年级
							</label>
							<div class="layui-input-block">
						...
						<div class="layui-form-item">
							<label class="layui-form-label"> <span class='x-red'>*</span>讲课老师
							</label>
							<div class="layui-input-block">
								<select name="article_category_id" id="article_category_id">
						...
						<div class="layui-form-item">
							<label class="layui-form-label"> <span class='x-red'>*</span>课程视频
							</label>
							<div class="layui-input-block">
								<input type="file" name="title" autocomplete="off" value=""
									placeholder="请输入选中的视频" class="layui-input" id="classMode">
						...
						<div class="layui-form-item">
							<label class="layui-form-label"> <span class='x-red'>*</span>课时费用
							</label>
							<div class="layui-input-block">
								<input type="text" name="title" autocomplete="off" value=""
									placeholder="请输入价格" class="layui-input" id="classMode">
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label"> <span class='x-red'>*</span>课程内容
							</label>
							<div class="layui-input-block">
								<input type="text" name="title" autocomplete="off" value=""
									placeholder="空制在80个汉字，160个字符以内" class="layui-input">
