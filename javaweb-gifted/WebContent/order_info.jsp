...
<body>
	...
	<div class="container">
		...
		<div>
			<hr />
			<form class="form-horizontal"   method="post"   action="PayServlet"   style="margin-top: 5px; margin-left: 150px;">
			...
			<div style="margin-top: 5px; margin-left: 150px;">
				...
				<p style="text-align: right; margin-right: 100px;">
					<!-- <a href="javascript:document.getElementById('orderForm').submit();"></a> -->
